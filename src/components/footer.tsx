 ...
 *   File: footer.tsx 
 *
 *   Purpose: footer element of the website
 *
 */ 
    ...
    <footer className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-12 mx-auto">
            ...
            <div className="flex items-center justify-between">
                <a href="#">
                    <img className="w-auto h-7" src={require("../assets/fixmi-logo.png")} alt="" />
                </a>
                ...
                <div className="flex -mx-2">
                    ...
                    <a href="https://github.com/IS-FixMi" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
